  ...
  axios
    ...
    .then(response => {
      if (response.data.message === "success") {
        showSuccessNotification(
          response.data.name + " нэртэй хэрэглэгч бүртгэгдэв."
        );
      } else {
...
function profiledit({ commit }, payload) {
  ...
  axios
    ...
    .then(response => {
      if (response.data.message === "success") {
        showSuccessNotification(
          response.data.name + " нэртэй хэрэглэгчийн мэдээлэл засагдлаа."
        );
...
function deletion({ commit }, payload) {
  ...
  axios
    ...
    .then(response => {
      if (response.data.message === "success") {
        showSuccessNotification(
          response.data.id + " кодтой хэрэглэгчийн бүртгэл устгагдлаа."
        );
      } else {
